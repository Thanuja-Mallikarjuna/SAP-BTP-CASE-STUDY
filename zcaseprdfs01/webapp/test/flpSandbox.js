		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zcaseprdfs01",
									"targetURL": "#comibmzcaseprd01zcaseprdfs01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzcaseprd01zcaseprdfs01-display": {
								"semanticObject": "comibmzcaseprd01zcaseprdfs01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zcaseprd01.zcaseprdfs01",
									"url": sap.ui.require.toUrl("com/ibm/zcaseprd01/zcaseprdfs01")
								}
							}
						}
					}
